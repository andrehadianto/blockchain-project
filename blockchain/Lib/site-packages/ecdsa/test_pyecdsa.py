...
class ECDSA(unittest.TestCase):
    ...
    def test_deterministic(self):
        ...
        k = rfc6979.generate_k(
            SECP256k1.generator.order(), secexp, sha256, sha256(data).hexdigest())
    ...
    def test_pubkey_strings(self):
        ...
        badcurve = Curve("unknown", None, FakeGenerator(),
                         (1, 2, 3, 4, 5, 6), None)
        ...
        self.assertTrue(pem.strip().endswith(
            b("-----END PUBLIC KEY-----")), pem)
    ...
    def test_public_key_recovery(self):
        ...
        for recovered_vk in recovered_vks:
            ...
            self.assertEqual(vk.default_hashfunc,
                             recovered_vk.default_hashfunc)
...
class OpenSSL(unittest.TestCase):
    ...
    def do_test_to_openssl(self, curve, hash_name="SHA1"):
        ...
        run_openssl(
            "dgst %s -verify t/pubkey.der -keyform DER -signature t/data.sig t/data.txt" % mdarg)
...
class RFC6979(unittest.TestCase):
    ...
    def test_SECP256k1_2(self):
        self._do(
            generator=SECP256k1.generator,
            secexp=int(
                "cca9fbcc1b41e5a95d369eaa6ddcff73b61a4efaa279cfc6567e8daa39cbaf50", 16),
            hsh=sha256(b("sample")).hexdigest(),
            hash_func=sha256,
    ...
    def test_SECP256k1_3(self):
        self._do(
            generator=SECP256k1.generator,
            secexp=0x1,
            hsh=sha256(b("Satoshi Nakamoto")).hexdigest(),
            hash_func=sha256,
    ...
    def test_SECP256k1_4(self):
        self._do(
            ...
            secexp=0x1,
            hsh=sha256(
                b("All those moments will be lost in time, like tears in rain. Time to die...")).hexdigest(),
            hash_func=sha256,
    ...
    def test_SECP256k1_6(self):
        self._do(
            ...
            hsh=sha256(b("Alan Turing")).hexdigest(),
            hash_func=sha256,
    ...
    def test_8(self):
        self._do(
            ...
            secexp=int(
                "0FAD06DAA62BA3B25D2FB40133DA757205DE67F5BB0018FEE8C86E1B68C7E75CAA896EB32F1F47C70855836A6D16FCC1466F6D8FBEC67DB89EC0C08B0E996B83538", 16),
            hsh=sha1(b("sample")).hexdigest(),
            hash_func=sha1,
